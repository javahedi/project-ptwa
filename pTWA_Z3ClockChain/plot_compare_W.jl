...
function load_run(path::String)
    @load path  L J gpair W Ndis Nmc seed tmax times sampling I_mean I_err n_mean
    return (path=path, times=times, I_mean=I_mean, I_err=I_err,
            n_mean=n_mean, L=L, W=W, gpair=gpair)
end

# ----------------------------
# Provide your two files here
# ----------------------------
file_W05 = "output/pTWA_Z3_parafermion_L12_g0.3_W0.5_Ndis100_Nmc100_discrete.jld2"
file_W1 = "output/pTWA_Z3_parafermion_L12_g0.3_W1.0_Ndis100_Nmc100_discrete.jld2"
file_W2 = "output/pTWA_Z3_parafermion_L12_g0.3_W2.0_Ndis100_Nmc100_discrete.jld2"
file_W4 = "output/pTWA_Z3_parafermion_L12_g0.3_W4.0_Ndis100_Nmc100_discrete.jld2"
...
lines!(ax, d05.times, d05.I_mean, label="W=$(d05.W)")
lines!(ax, d1.times, d1.I_mean, label="W=$(d1.W)")
lines!(ax, d2.times, d2.I_mean, label="W=$(d2.W)")
lines!(ax, d4.times, d4.I_mean, label="W=$(d4.W)")
